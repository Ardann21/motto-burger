...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[110vh] md:h-[300vh] py-4 pb-20 md:py-40 -mt-44 md:mt-0 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
